...
| Topic  | Quiz | Notes |
|--- |--- | --- |
| [Introduction to Neural Networks](https://codelabs.developers.google.com/codelabs/cloud-tensorflow-mnist) | [link](https://forms.gle/85t1ZDoj4t9Xb8zW7) | The quiz covers sections 1 to 4 of the tutorial.|
| Advanced Neural Networks (adding layers, regularization, convolutional NNs)  | - | The quiz covers sections 5 to 15 of the tutorial. |
...
| Recurrent neural networks | - | [Visualizing and Understanding Recurrent Networks](https://arxiv.org/pdf/1506.02078.pdf) | GRU, LSTM, word representation, examples | 
